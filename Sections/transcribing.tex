...
When the audio data has been captured form the microphone, send to the Raspberry Pi and published on a MQTT topic, the PC needs to transcribe the audio data into text for it to be useful. This is done on the processing layer using OpenAI's Whisper model.\cite{whisper_paper} 
