...
When the TDOA has been calculated using GCC-PHAT, the sample offset between the microphones can be converted to time by multiplying by the speed of sound (343 m/s). 