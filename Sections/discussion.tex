...
As seen in \cref{sec:testing}
The system that gets the best TDOA estimates, when GCC-PHAT is set to a weight of ??? and when a filter/nofilter is applied. When comparing the sample size GCC-PHAT performs best with ??? samples. 
