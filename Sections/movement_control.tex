...
Furthermore, the motor mounted on the TurtleBot has an inbuilt PID regulation \cite{motor_Specifications}, which regulates the motors' velocity.

Both PID control and position-based driving are necessary for the robot to drive in a straight line or as instructed. These instruction can then be kept in a list to backtrace the robot's path if needed.