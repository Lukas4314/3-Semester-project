...
def test_gcc_phat():
    ...
    """
    tdoa_01 = PHAT_GCC_TDOA_with_correlation(signals[0], signals[1])  # mic1 vs mic0
    tdoa_02 = PHAT_GCC_TDOA_with_correlation(signals[0], signals[2])  # mic2 vs mic0
    tdoa_12 = PHAT_GCC_TDOA_with_correlation(signals[1], signals[2])  # mic2 vs mic1

    visualize_cross_correlations(signals, sample_rate=sampling_rate)
